...
test("unknown commitments and forecast are presented as unavailable",()=>{assert.match(web,/commitments:null/);assert.match(web,/forecastCostToComplete:null/);assert.match(mobile,/Unpaid Commitments/);assert.match(mobile,/Forecast Final Cost/);});
